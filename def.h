...
typedef struct bitvecrec {
    char *vector;
    /* Sequence of bytes to hold bitvector */
    int size;
    /* Of vector, in bytes */
    int pos;
    /* Current byte number */
    ...
    /* Current bit in byte */
    int cur;
    /* Temporary space for putting, getting bits */
    int len;
    /* Number of bits used */
...
typedef struct gramtreenode {
    ...
    /* Characters of gram */
    BITVEC vec;
    /* Containing ptrs to words with gram */
...
typedef struct gramnode {
    ...
    /* Containing ptrs to words with gram */
    BITVEC svec;
    /* Containing skip ptrs */
    BITVEC saddrvec;
    /* Containing ptrs to the ptrs in vec */
